...
const Body =
    ...
    <>
        <main>
            ...
            <p>Having a simple way to build HTML files from JSX is a good start, but NakedJSX can a lot more than that.</p>
            ...
            <Dep name="Babel" url="https://babeljs.io" donate="https://opencollective.com/babel" plugins="Plus @babel/generator, @babel/plugin-transform-react-jsx, and @babel/plugin-proposal-decorators plugins, and @babel/preset-env preset.">
                <ul>
